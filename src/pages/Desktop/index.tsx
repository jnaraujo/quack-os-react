...
const Desktop = () => {
  ...
  return (
    <>
      <main className="fixed flex h-screen w-screen flex-col overflow-hidden bg-blue-700 bg-duck bg-[length:200px_200px] bg-center bg-no-repeat">
        <TopBar />

        <div className="flex-1 bg-dot-pattern bg-[length:50px] bg-repeat">
          {apps.map((app) => (
